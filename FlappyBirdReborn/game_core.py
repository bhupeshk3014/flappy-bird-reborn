...
PLAYERS_LIST = (
    # red bird
    (
        './FlappyBirdReborn/assets/sprites/redbird-upflap.png',
        './FlappyBirdReborn/assets/sprites/redbird-midflap.png',
        './FlappyBirdReborn/assets/sprites/redbird-downflap.png',
    ),
    # blue bird
    (
        # amount by which base can maximum shift to left
        './FlappyBirdReborn/assets/sprites/bluebird-upflap.png',
        './FlappyBirdReborn/assets/sprites/bluebird-midflap.png',
        './FlappyBirdReborn/assets/sprites/bluebird-downflap.png',
    ),
    # yellow bird
    (
        './FlappyBirdReborn/assets/sprites/yellowbird-upflap.png',
        './FlappyBirdReborn/assets/sprites/yellowbird-midflap.png',
        './FlappyBirdReborn/assets/sprites/yellowbird-downflap.png',
    ),
)

# list of backgrounds
BACKGROUNDS_LIST = (
    './FlappyBirdReborn/assets/sprites/background-day.png',
    './FlappyBirdReborn/assets/sprites/background-night.png',
)

# list of pipes
PIPES_LIST = (
    './FlappyBirdReborn/assets/sprites/pipe-green.png',
    './FlappyBirdReborn/assets/sprites/pipe-red.png',
)
...
IMAGES['numbers'] = (
    pygame.image.load('./FlappyBirdReborn/assets/sprites/0.png').convert_alpha(),
    pygame.image.load('./FlappyBirdReborn/assets/sprites/1.png').convert_alpha(),
    pygame.image.load('./FlappyBirdReborn/assets/sprites/2.png').convert_alpha(),
    pygame.image.load('./FlappyBirdReborn/assets/sprites/3.png').convert_alpha(),
    pygame.image.load('./FlappyBirdReborn/assets/sprites/4.png').convert_alpha(),
    pygame.image.load('./FlappyBirdReborn/assets/sprites/5.png').convert_alpha(),
    pygame.image.load('./FlappyBirdReborn/assets/sprites/6.png').convert_alpha(),
    pygame.image.load('./FlappyBirdReborn/assets/sprites/7.png').convert_alpha(),
    pygame.image.load('./FlappyBirdReborn/assets/sprites/8.png').convert_alpha(),
    pygame.image.load('./FlappyBirdReborn/assets/sprites/9.png').convert_alpha()
)

# game over sprite
IMAGES['gameover'] = pygame.image.load('./FlappyBirdReborn/assets/sprites/gameover.png').convert_alpha()
# message sprite for welcome screen
IMAGES['message'] = pygame.image.load('./FlappyBirdReborn/assets/sprites/message.png').convert_alpha()
# base (ground) sprite
IMAGES['base'] = pygame.image.load('./FlappyBirdReborn/assets/sprites/base.png').convert_alpha()
...
SOUNDS['die']    = pygame.mixer.Sound('./FlappyBirdReborn/assets/audio/die' + soundExt)
SOUNDS['hit']    = pygame.mixer.Sound('./FlappyBirdReborn/assets/audio/hit' + soundExt)
SOUNDS['point']  = pygame.mixer.Sound('./FlappyBirdReborn/assets/audio/point' + soundExt)
SOUNDS['swoosh'] = pygame.mixer.Sound('./FlappyBirdReborn/assets/audio/swoosh' + soundExt)
SOUNDS['wing']   = pygame.mixer.Sound('./FlappyBirdReborn/assets/audio/wing' + soundExt)
